...
export interface CreditCardBackContextValue {
  safeArea: number
}
...
export function Demo() {
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-gradient-to-br from-slate-900 to-slate-800 p-8">
      <CreditCard>
        <CreditCardFlipper>
          <CreditCardFront className="bg-gradient-to-br from-violet-600 to-indigo-900">
            <CreditCardChip />
            <CreditCardLogo>
              <svg viewBox="0 0 24 24" fill="currentColor" className="size-full opacity-80">
                <path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5" />
              </svg>
            </CreditCardLogo>
            <div className="absolute bottom-0 left-0 right-0 flex flex-col gap-2">
              <CreditCardNumber>4532 •••• •••• 7890</CreditCardNumber>
          ...
          <CreditCardBack className="bg-gradient-to-br from-violet-600 to-indigo-900">
            <CreditCardMagStripe />
            <div className="absolute bottom-1/4 right-0 flex items-center gap-2">
              <div className="h-8 w-3/4 bg-white/90" />
