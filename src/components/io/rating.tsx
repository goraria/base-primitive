...
//         <span className="text-sm text-muted-foreground">Interactive Rating</span>
...
//           <RatingButton />
//         </Rating>
//         <span className="text-sm">Selected: {value} stars</span>
//       </div>
//
//       <div className="flex flex-col items-center gap-2">
//         <span className="text-sm text-muted-foreground">Read-only Display</span>
...
//
//       <div className="flex flex-col items-center gap-2">
//         <span className="text-sm text-muted-foreground">Default Value (Uncontrolled)</span>
